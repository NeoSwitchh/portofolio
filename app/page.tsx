...
export default function HomePage() {
  return (
    <section className="flex flex-col items-start justify-start gap-4 py-8 md:py-10">
      <div className="flex flex-row w-full text-start justify-center">
        <div className="items-center justify-start">
          <h1 className="">Hi!👋</h1>
          <p className="">I'm Abiyyu Dzaky Muhammad</p>
          <span className="w-full">
          Your backend developer who is passionate about building systems that
            <Typewriter
              words={[
                " is secure"," is optimized", " matter"
              ]}
              loop={5}
              cursor
